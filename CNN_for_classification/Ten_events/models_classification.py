...
def get_model(args,loss_function='categorical_crossentropy',initial_lr=0.0001,weights="imagenet"):
  """
  ...
  if args.model=='vgg16':
    ...
    preds=Dense(args.classes,activation='softmax')(x) #final layer with softmax activation
